...
Команда которая позволяет переходить между разными ветками git checkout. Для перехода на неоходимую ветку ввести команду:

    git checkout <имя ветки>

Для перехода в основную ветку branch master, необходимо ввести команду : 

    git checkout master

### Графическое отображение веток

Для графического отображения всех коммитов в ветках, можно использовать команду:

    git log --oneline --all –graph

Выводит графическое отображение веток с кратким содержанием коммитов (дерево коммитов).
...
В ветку branch master сливают все другие ветки , в ней содержится основной материал.
