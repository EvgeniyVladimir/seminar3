...
В случае, если на разных ветках в одинаковых строках текст написан по-разному, то возникнет конфликт, когда буду эти ветки сливать. Git не поймёт какую версию из разных веток необходимо использовать, версию которую была на ветке мастер или в ветке которую заливаю (что пришло снаружи) и предлагает мне решить самостоятельно.
